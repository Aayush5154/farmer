...
/* ────────────────────────────────────────────────────────────────
   Helper components – keep them inside the same file so the import
   paths stay exactly the same as in your original file.
   ──────────────────────────────────────────────────────────────── */
...
export default function Register() {
  ...
  const [showPass, setShowPass] = useState(false)   // password visibility flag
  ...
  return (
    <main className="min-h-screen flex">
      {/* ── LEFT – decorative background (desktop only) ───────────── */}
      <div
      ...
      >
        ...
        {/* Content wrapper (keeps everything centered) */}
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          <p className="text-emerald-200/80 text-lg xl:text-xl max-w-md leading-relaxed mb-8">
            Create your profile, secure your farm insurance, and start tracking your yields.
          </p>
      ...
      {/* ── RIGHT – the actual register form ─────────────────────── */}
      <div className="w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center bg-gradient-to-br from-emerald-950 via-emerald-950 to-teal-950 p-6 sm:p-8 lg:p-12 relative overflow-hidden">
        ...
        {/* Decorative blobs that sit behind the form */}
        ...
        {/* The card that actually holds the form */}
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="hidden lg:block mb-8">
            ...
            <p className="text-emerald-300/70">Enter your details and start protecting your farm.</p>
          </div>
          ...
          <section className="bg-emerald-900/30 backdrop-blur-xl border border-emerald-700/30 rounded-3xl p-8 shadow-2xl shadow-emerald-950/50">
            <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
              ...
              <div>
                ...
                <div className="mt-2 relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg className="w-5 h-5 transition-colors duration-200 mr-2 text-emerald-500 group-focus-within:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl bg-emerald-950/50 outline-none transition-all duration-200 text-white placeholder-emerald-400/50
                              ${errors.name ? "border-red-500/50 focus:border-red-500 focus:ring-2 focus:ring-red-500/20" : "border-emerald-700/50 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"}`}
                  />
                </div>
                {errors.name && (
              ...
              <div>
                ...
                <div className="mt-2 relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl bg-emerald-950/50 outline-none transition-all duration-200 text-white placeholder-emerald-400/50
                              ${errors.email ? "border-red-500/50 focus:border-red-500 focus:ring-2 focus:ring-red-500/20" : "border-emerald-700/50 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"}`}
                  />
                </div>
                {errors.email && (
                  <p className="mt-1 text-sm text-red-400 flex items-center gap-1.5">
                ...
                <div className="mt-2 relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-12 py-3.5 border-2 rounded-xl bg-emerald-950/50 outline-none transition-all duration-200 text-white placeholder-emerald-400/50
                              ${errors.password ? "border-red-500/50 focus:border-red-500 focus:ring-2 focus:ring-red-500/20" : "border-emerald-700/50 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"}`}
                  />
                  {/* Toggle visibility */}
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className={`relative w-full py-4 rounded-xl font-semibold text-lg text-emerald-950 bg-emerald-400 hover:bg-emerald-300 focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 focus:ring-offset-emerald-900 transition-all
                          ${isSubmitting
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 py-3 border-2 border-emerald-700/50 rounded-xl text-emerald-200 hover:bg-emerald-800/30 hover:border-emerald-600/50 transition-all duration-200 group"
              >
                {/* Simple GitHub icon – replace with your own if you wish */}
            ...
            <p className="mt-8 text-center text-sm text-emerald-300/70">
              ...
              <Link
                to="/login"
                onMouseEnter={() => import("./Login" /* webpackPrefetch: true */).catch(() => {})}
